...
// Initialize global logger as in certain situations it doesn't make much sense
// to pass it (e.g. for auxiliary things like conf.Load(), etc.)
func Setup(gcp bool) {
	if gcp {
		// This is optimized for GCP Cloud Logging Agent to recognize level and
		// message; rest of fields is accessible vial jsonPayload.
...
// Exported functions so logging feels natural with log
